...
export const translations = {
  en: {
    ...
    "app.versionReady": "Full workflow",
    "language.label": "Language",
    "language.draftPreviewWarning": "Translation review mode — review national terminology before exam delivery.",
    "role.centre": "Centre",
    ...
    "help.candidate.photos": "Consulting report photo entries are stored as examination photo records.",
    ...
    "centre.validation.ready": "Ready for exam session check",
    "centre.validation.action": "Action required before exam session check",
    "centre.validation.helper": "Errors should be fixed before distributing QR links. Warnings should be reviewed before opening the exam session.",
    "centre.validation.empty": "No validation issues. Setup is ready for the exam session.",

    "centre.guardrails.title": "Operational readiness checks",
    "centre.guardrails.helper": "These checks should be resolved before opening the exam session.",
    "centre.guardrails.ready": "Operational readiness looks good.",
    ...
    "centre.guardrails.testPackage": "Import/select a test package before opening the written test.",
    "centre.guardrails.backend": "Load saved Centre Setup before opening the exam session.",

    "centre.run.title": "Exam session summary",
    ...
    "centre.run.backend": "Centre exam data",
    "centre.run.demo": "local exam data",
    ...
    "centre.run.qrReady": "Ready after setup is saved and Centre-loaded",
    "centre.run.review": "Review guardrails",

    "centre.network.title": "Network readiness checklist",
    "centre.network.helper": "Use this before distributing Candidate QR and Examiner QR links during the exam session.",
    ...
    "qr.subtitle": "Give each Candidate or Examiner only their own Candidate QR or Examiner QR link. Centre QR URLs appear after Load/Save Centre Setup.",
    "qr.candidateLinks": "Candidate QR links",
    "qr.examinerLinks": "Examiner QR links",
    "qr.copy": "Copy link",
    "qr.candidateBackend": "Centre-loaded Candidate QR",
    "qr.candidateDemo": "local Candidate QR",
    "qr.examinerBackend": "Centre-loaded Examiner QR",
    "qr.examinerDemo": "local Examiner QR",
  },

  cs: {
    "app.title": "VetBara",
    "app.subtitle": "Digitální zkušební prostředí",
    "app.versionReady": "Plné workflow",
    "language.label": "Jazyk",
    "language.draftPreviewWarning": "Režim kontroly překladu — před použitím při zkoušce zkontrolujte národní terminologii.",
    "role.centre": "Centrum",
    ...
    "help.candidate.photos": "Foto položky v Consulting reportu se ukládají jako zkušební fotozáznamy.",
    ...
    "centre.validation.ready": "Připraveno ke kontrole zkušební session",
    "centre.validation.action": "Před otevřením zkušební session je potřeba zásah",
    "centre.validation.helper": "Chyby opravte před distribucí QR odkazů. Varování zkontrolujte před otevřením zkušební session.",
    "centre.validation.empty": "Žádné validační problémy. Setup je připraven pro zkušební session.",

    "centre.guardrails.title": "Kontroly provozní připravenosti",
    "centre.guardrails.helper": "Tyto kontroly by měly být vyřešeny před otevřením zkušební session.",
    "centre.guardrails.ready": "Provozní připravenost vypadá dobře.",
    ...
    "centre.guardrails.testPackage": "Importujte/vyberte testový balíček před otevřením písemného testu.",
    "centre.guardrails.backend": "Před otevřením zkušební session načtěte uložený Centre Setup.",

    "centre.run.title": "Souhrn zkušební session",
    ...
    "centre.network.helper": "Použijte před distribucí Candidate QR a Examiner QR odkazů během zkušební session.",
    ...
    "qr.subtitle": "Každému kandidátovi nebo zkoušejícímu předejte pouze jeho vlastní Candidate QR nebo Examiner QR odkaz. QR URL z Centra se zobrazí po Load/Save Centre Setup.",
...
Object.assign(translations.en, {
  ...
  "report.helper": "Prepare field notes and final text for the Consulting report. Photo entries are stored as examination photo records.",
  "report.tree": "Tree",
  "report.fieldNotes": "Field notes",
  "report.finalText": "Final text",
  "report.photoPlaceholder": "Photo record / archive note",
  "report.addPhoto": "Add photo record",
...
Object.assign(translations.cs, {
  ...
  "report.helper": "Připravte terénní poznámky a finální text pro Consulting report. Foto položky se ukládají jako zkušební fotozáznamy.",
  "report.tree": "Strom",
  "report.fieldNotes": "Terénní poznámky",
  "report.finalText": "Finální text",
  "report.photoPlaceholder": "Fotozáznam / archivní poznámka",
  "report.addPhoto": "Přidat fotozáznam",
...
Object.assign(translations.en, {
  ...
  "outdoor.paperArchive.helper": "Candidate prepares this on paper. Examiner stores it as an examination archive photo.",
...
Object.assign(translations.cs, {
  ...
  "outdoor.paperArchive.helper": "Kandidát připravuje tuto část na papíře. Zkoušející ji uloží jako archivní fotozáznam zkoušky.",
...
Object.assign(translations.en, {
  ...
  "evaluation.preview.photoPlaceholders": "Photo records",
...
Object.assign(translations.cs, {
  ...
  "evaluation.preview.photoPlaceholders": "Fotozáznamy",
...
Object.assign(translations.en, {
  ...
  "centre.access.centreToken": "Centre token",
  ...
  "centre.dataMode.backendHelper": "This session uses Centre exam data.",
  "centre.dataMode.demoHelper": "This session uses local exam data. Load Centre Setup to use Centre exam data.",
  "centre.dataMode.saveAfterChanges": "Save Centre Setup after changing roster, examiners, assignments, or imported tests.",
  "centre.dataMode.backend": "Centre exam data",
  "centre.dataMode.demo": "local exam data",
...
Object.assign(translations.cs, {
  ...
  "centre.access.centreToken": "Token centra",
  ...
  "centre.dataMode.backendHelper": "Tato session používá Centre exam data.",
  "centre.dataMode.demoHelper": "Tato session používá lokální data. Načtením Centre Setup použijete data z Centra.",
...
Object.assign(translations.en, {
  "centre.workflow.title": "Exam workflow status",
  "centre.workflow.helper": "Exam workflow status across setup, assignments, candidate sections, responses, report drafts and outdoor scoring.",
  ...
  "centre.workflow.demoWarning": "This session uses local exam data. Load Centre Setup to use Centre exam data.",
...
Object.assign(translations.cs, {
  "centre.workflow.title": "Stav zkušebního workflow",
  "centre.workflow.helper": "Stav zkušebního workflow napříč setupem, přiřazeními, částmi kandidáta, odpověďmi, návrhy reportů a outdoor skórováním.",
  ...
  "centre.workflow.demoWarning": "Tato session používá lokální data. Načtěte Centre Setup pro použití dat z Centra.",
