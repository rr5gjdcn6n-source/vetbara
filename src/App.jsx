...
function CentreValidationSummary({ issues }) {
...
function PilotReadinessGuardrails({ centreValidationIssues, centreSetupDirty, testImportSummary, dataMode }) {
  const warnings = [
...
function PilotRunSummary({ centreValidationIssues, centreSetupDirty, testImportSummary, dataMode }) {
